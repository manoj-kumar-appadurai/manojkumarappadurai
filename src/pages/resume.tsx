...
export default function Resume() {
  ...
  return (
    <>
      <Head>
        <title>{currentLang === 'ta' ? 'சுயவிவரம் | சரவணகுமார்' : 'Resume | Manoj Kumar Appadurai'}</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content={currentLang === 'ta' ? 'சுயவிவரம் | சரவணகுமார்' : 'Resume | Manoj Kumar Appadurai'} />
        <meta
      ...
      <Section>
        ...
        <Description style={{ width: '100%', textAlign: 'center', marginBottom: '1px' }}>
          {currentLang === 'ta' ? 'இது எனது புதுப்பிக்கப்பட்ட சுயவிவரம், Canva இணையதளத்தால் இயக்கப்படுகிறது. கீழே உள்ள பதிவிறக்க பொத்தானைக் கிளிக் செய்வதன் மூலம் எனது தொழில்முறை சுயவிவரத்தை நீங்கள் பதிவிறக்கம் செய்யலாம்.' : 'Looking for my latest experience and skills? You can download my updated resume by clicking the button below.'}
        </Description>

        <PageSection>
          <iframe
            src="/pdf/Manoj_Kumar_Appadurai_Resume.pdf"
            width="100%"
            height="780"
            title="Manoj Kumar Resume"
            style={{ border: 'none' }}
          />
