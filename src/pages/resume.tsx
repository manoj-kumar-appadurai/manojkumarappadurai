...
export default function Resume() {
  ...
  return (
    <>
      <Head>
        <title>{currentLang === 'ta' ? 'சுயவிவரம் | சரவணகுமார்' : 'Resume | Manoj Kumar'}</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content={currentLang === 'ta' ? 'சுயவிவரம் | சரவணகுமார்' : 'Resume | Manoj Kumar'} />
        <meta
